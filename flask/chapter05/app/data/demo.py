...
if __name__=="__main__":
    ...
    # outbox=filter_box(output,0.5,0.5)
    # # print(f'or_img = {or_img}')
    # # print(f'or_img type = {type(or_img)}-------------')
    # im, nums_dict = draw(or_img,outbox)

    # im = cvImgAddText(im, f'一共有：{nums_dict["人"]} 人', 0, 100 , (255,0, 0))
    # im = cvImgAddText(im, f'一共有：{nums_dict["货车"]} 部货车', 0, 120, (255, 0, 0))
    # im = cvImgAddText(im, f'一共有：{nums_dict["小车"]} 小车', 0, 140, (255, 0, 0))
